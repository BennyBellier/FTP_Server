...
int main(int argc, char **argv)
{
  ...
  //*Connexion au répartiteur de charge pour récupérer l'host et le port du serveur traitant
  ...
  //* Nouvelle connexion vers le serveur ftp
  // serv_info.fd = Open_clientfd(msg.content, msg.value);
  // Rio_readinitb(&serv_info.rio, serv_info.fd);
